...
async fn main() -> anyhow::Result<()> {
    ...
    // This log goes to the main logger (used by libraries)
    info!("This is a log from the main logger");
    ...
    setup_verification(&client).await;
...
async fn setup_verification(client: &Client) {
